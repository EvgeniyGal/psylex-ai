...
/**
 * Live room updates via Postgres LISTEN/NOTIFY (SSE) and optional Supabase Realtime WS.
 * No interval polling while push transport is active.
 */
...
/**
 * Live user updates for testing dashboard (SSE + optional Supabase).
 */
