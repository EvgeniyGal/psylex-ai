...
export function WelcomeScreen({ role }: WelcomeScreenProps) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-background font-sans text-on-background">
      <PortalHeader />

      <main className="relative flex flex-grow items-center justify-center px-margin-mobile pb-12 pt-28 md:px-margin-desktop">
